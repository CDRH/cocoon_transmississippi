    ...
    <xsl:template match="/">
        <xsl:element name="html">
            ...
            <head>
                ...
                <link
                    href="https://fonts.googleapis.com/css2?family=Goudy+Bookletter+1911&amp;family=Rokkitt&amp;family=Stint+Ultra+Expanded&amp;family=Tangerine&amp;display=swap"
                    rel="stylesheet"/>
                ...
                <!-- Pretty Photo -->
                <link rel="stylesheet"
                    href="{$siteroot}files/js/prettyPhoto_compressed_3.1.3/css/prettyPhoto.css"
                ...
                <script async="true" src="https://www.googletagmanager.com/gtag/js?id=G-M1S6YLPYCQ">&#160; </script>
                <!-- Expand Text -->
